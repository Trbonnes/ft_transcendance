<template>
  <div class="flex flex-col items-center h-full w-full bg-gray-100">
    <div class="w-full">
      <div v-for="c in channels" class="card text-black font-bold my-1">
        <div @click="$emit('select', c)" class="card-body bg-white hover:bg-gray-100 transition-all duration-300 cursor-pointer w-full flex flex-row items-center justify-between">
