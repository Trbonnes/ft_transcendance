...
export class init1630357735806 implements MigrationInterface {
    name = 'init1630357735806'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "channel_membership" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isAdmin" boolean NOT NULL, "isBanned" boolean NOT NULL, "userId" uuid, "channelId" uuid, CONSTRAINT "PK_2adcd844f2ef3a3f79fb64facd6" PRIMARY KEY ("id"))`);
