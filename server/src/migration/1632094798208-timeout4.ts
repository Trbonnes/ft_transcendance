...
export class timeout41632094798208 implements MigrationInterface {
    name = 'timeout41632094798208'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."channel_timeout" ADD CONSTRAINT "FK_bcef2f3d47afb0caf24405cd89c" FOREIGN KEY ("membershipId") REFERENCES "channel_membership"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
