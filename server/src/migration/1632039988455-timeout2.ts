...
export class timeout21632039988455 implements MigrationInterface {
    name = 'timeout21632039988455'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."channel_timeout" ADD "end" TIMESTAMP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "public"."channel_timeout" ADD "start" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "public"."channel_timeout" ADD "membershipId" character varying NOT NULL`);
    }
