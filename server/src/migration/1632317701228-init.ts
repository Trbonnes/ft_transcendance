...
export class init1632317701228 implements MigrationInterface {
  name = 'init1632317701228'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE EXTENSION furzzystrmatch`);
    await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "login" character varying NOT NULL, "firstName" character varying NOT NULL, "displayName" character varying NOT NULL, "role" character varying NOT NULL, "avatar" character varying NOT NULL, "defaultAvatar" character varying NOT NULL, "avatarFileName" character varying NOT NULL, "isActive" boolean NOT NULL, "inGame" boolean NOT NULL, "twoFactor" boolean NOT NULL DEFAULT false, "twoFactorCode" character varying, "victory" integer NOT NULL, "defeat" integer NOT NULL, "level" integer NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "lastUpdated" TIMESTAMP NOT NULL DEFAULT now(), "friends" text array NOT NULL DEFAULT '{}', "game_id" character varying NOT NULL DEFAULT '', "blockerId" uuid, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_a62473490b3e4578fd683235c5e" UNIQUE ("login"), CONSTRAINT "UQ_059e69c318702e93998f26d1528" UNIQUE ("displayName"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "channel_timeout" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "membershipId" uuid NOT NULL, "start" TIMESTAMP NOT NULL DEFAULT now(), "end" TIMESTAMP NOT NULL, CONSTRAINT "REL_bcef2f3d47afb0caf24405cd89" UNIQUE ("membershipId"), CONSTRAINT "PK_89d6a7730141f20efb148357f18" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "channel_membership" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "channelId" uuid NOT NULL, "isAdmin" boolean NOT NULL, CONSTRAINT "PK_2adcd844f2ef3a3f79fb64facd6" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "direct_channel" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user1Id" uuid NOT NULL, "user2Id" uuid NOT NULL, CONSTRAINT "PK_fae1b3c7bbaba05150bc9729d0c" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`ALTER TABLE "channel_timeout" DROP CONSTRAINT "REL_bcef2f3d47afb0caf24405cd89"`);
    ...
    await queryRunner.query(`ALTER TABLE "channel_timeout" ADD "membershipId" uuid NOT NULL`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" ADD CONSTRAINT "UQ_bcef2f3d47afb0caf24405cd89c" UNIQUE ("membershipId")`);
    ...
    await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_75fb061d75fd1f89cb87e963682" FOREIGN KEY ("blockerId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    await queryRunner.query(`ALTER TABLE "channel_timeout" ADD CONSTRAINT "FK_bcef2f3d47afb0caf24405cd89c" FOREIGN KEY ("membershipId") REFERENCES "channel_membership"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "channel_timeout" DROP CONSTRAINT "FK_bcef2f3d47afb0caf24405cd89c"`);
    ...
    await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_75fb061d75fd1f89cb87e963682"`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" DROP COLUMN "end"`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" DROP COLUMN "start"`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" DROP CONSTRAINT "UQ_bcef2f3d47afb0caf24405cd89c"`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" DROP COLUMN "membershipId"`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" ADD "end" TIMESTAMP NOT NULL`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" ADD "start" TIMESTAMP NOT NULL DEFAULT now()`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" ADD "membershipId" uuid NOT NULL`);
    await queryRunner.query(`ALTER TABLE "channel_timeout" ADD CONSTRAINT "REL_bcef2f3d47afb0caf24405cd89" UNIQUE ("membershipId")`);
